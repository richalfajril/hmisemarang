...
## Corpus Check
- 349 files · ~138,960 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1491 nodes · 3771 edges · 123 communities (74 shown, 49 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a6d44bd`
...
Cohesion: 0.07
Nodes (74): AgendaFormProps, ArticleFormProps, Account, ImportResult, ProfileFormProps, DocumentFormProps, SortKey, AlbumFormProps (+66 more)

### Community 1 - "Public Listing Pages"
Cohesion: 0.12
Nodes (34): ArticleListProps, ArticleWithRelations, statusColorMap, ShareButtons(), CadreVerificationData, CadreVerificationTable(), KomisariatGrid(), PublicCommissariat (+26 more)

### Community 2 - "UI Primitives (cn/Drawer)"
Cohesion: 0.09
Nodes (27): cn(), DialogOverlay(), DrawerContent(), DrawerDescription(), DrawerFooter(), DrawerHeader(), DrawerOverlay(), DrawerTitle() (+19 more)
...
Cohesion: 0.08
Nodes (40): react, react, useIsMobile(), Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarFooter() (+32 more)

### Community 6 - "CMS Create/Edit Pages"
Cohesion: 0.08
Nodes (25): CreateAgendaPage(), EditAgendaPage(), AgendasPage(), CreateArticlePage(), EditArticlePage(), ArticlesPage(), EditDocumentPage(), NewDocumentPage() (+17 more)

### Community 7 - "SEO & Public Detail Pages"
Cohesion: 0.13
Nodes (26): dateFmt, generateMetadata(), Page(), generateMetadata(), getCommissariat(), Page(), FALLBACK, metadata (+18 more)
...
Cohesion: 0.16
Nodes (17): AuditLogsPage(), ChangePasswordPage(), MediaCleanupPage(), NotificationsPage(), PeriodsPage(), SettingsPage(), UsersPage(), changePasswordAction() (+9 more)

### Community 10 - "Agenda/Article Schemas & Actions"
Cohesion: 0.14
Nodes (20): AgendaFormValues, agendaSchema, ArticleFormValues, articleSchema, bulkArchiveAgendasAction(), generateSlug(), saveAgendaDraftAction(), softDeleteAgendaAction() (+12 more)

### Community 11 - "Public Article Queries"
Cohesion: 0.12
Nodes (25): metadata, Page(), ARTICLE_FALLBACK, firstParagraph(), getAllPublicArticles, getLatestArticles, getPopularArticles, PublicArticle (+17 more)

### Community 12 - "Homepage Sections"
Cohesion: 0.09
Nodes (26): AnimatedSection(), Props, Props, Section(), AGENDA_FALLBACK, getFeaturedArticles, getUpcomingAgendas, AgendaCarousel() (+18 more)

### Community 13 - "Route Handlers & CMS Pages"
Cohesion: 0.13
Nodes (14): metadata, DocumentsPage(), metadata, metadata, metadata, metadata, TaxonomyPage(), metadata (+6 more)
...
Cohesion: 0.06
Nodes (53): metadata, PeriodDetailPage(), toSocialLinks(), getAllPeriods(), getOrganizationByPeriod(), GROUP_TITLES, metadata, Page() (+45 more)
...
Cohesion: 0.17
Nodes (14): ReviewDetailPage(), ACCEPTED_FILE_TYPES, cadreVerificationSchema, ACCEPTED_FILE_TYPES, DocumentFormValues, documentSchema, uploadCadreFileAction(), getPublicDocumentUrlAction() (+6 more)
...
Cohesion: 0.13
Nodes (17): metadata, Page(), metadata, Page(), HeroSearchBox(), GALLERY_FALLBACK, getPublicAlbumCount, getPublicCommissariats (+9 more)
...
Cohesion: 0.11
Nodes (19): containerVariants, GalleryBento(), GalleryPhoto, itemVariants, SPANS, useHorizontalWheel(), getGalleryAlbums, getTestimonials (+11 more)

### Community 25 - "About/Gallery Sections"
Cohesion: 0.14
Nodes (13): getPublicDocuments(), metadata, Page(), metadata, MISI, VALUES, DocumentSearchBox(), PublicDocument (+5 more)

### Community 26 - "Login & Auth Form"
Cohesion: 0.12
Nodes (18): DashboardLayout(), Field(), FieldContent(), FieldDescription(), FieldError(), FieldGroup(), FieldLabel(), FieldLegend() (+10 more)
...
Cohesion: 0.14
Nodes (19): AlbumDetailsPage(), GalleriesPage(), ACCEPTED_IMAGE_TYPES, AlbumFormValues, albumSchema, photoSchema, deletePhotoAction(), setAlbumCoverAction() (+11 more)

### Community 29 - "Review Queue & Taxonomy Tabs"
Cohesion: 0.09
Nodes (37): CadreVerificationPage(), CabangLeaderboardData(), CabangStatsSection(), CommissariatDashboardSection(), DashboardOverview(), metadata, VerificationForm(), VerificationFormProps (+29 more)
...
Cohesion: 0.10
Nodes (21): createClient(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage(), DropdownMenuCheckboxItem() (+13 more)
...
Cohesion: 0.27
Nodes (9): TestimonialsPage(), TestimonialFormValues, testimonialSchema, canManage(), deleteTestimonialAction(), saveTestimonialAction(), togglePublishTestimonialAction(), TestimonialEntry (+1 more)
...
Cohesion: 0.50
Nodes (4): getDashboardLogo(), LoginPage(), metadata, LoginForm()

### Community 48 - "Taxonomy Import Actions"
Cohesion: 0.15
Nodes (15): xlsx, metadata, UniversitiesPage(), createTaxonomyAction(), importUniversitiesAction(), taxonomySchema, toggleTaxonomyStatusAction(), UniversityImportResult (+7 more)

### Community 49 - "Profile & Settings Schemas"
Cohesion: 0.20
Nodes (8): ProfileSubmissionFormValues, profileSubmissionSchema, saveProfileDraftAction(), ProfileForm(), updateSettingsAction(), websiteSettingsSchema, SettingsForm(), ActionState
...
- **Why does `cn()` connect `UI Primitives (cn/Drawer)` to `Cabang Dashboard Sections`, `Public Listing Pages`, `Period Detail & Board`, `Error/Empty States & Search`, `Supabase Client & Avatar`, `Sidebar & Navigation Shell`, `SEO & Public Detail Pages`, `Homepage Sections`, `Route Handlers & CMS Pages`, `Global Search & Command Palette`, `Root Layout & Providers`, `Chart Components`, `InputGroup Component`, `Homepage Carousels`, `About/Gallery Sections`, `Login & Auth Form`, `Review Queue & Taxonomy Tabs`, `Sheet & Public Header`?**
  _High betweenness centrality (0.179) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Core Runtime Dependencies` to `Dev Dependencies & Tooling`, `Sidebar & Navigation Shell`, `Taxonomy Import Actions`, `Excel Import Helpers`, `cloudinary`, `clsx`, `cmdk`, `date-fns`, `@dnd-kit/core`, `@dnd-kit/modifiers`, `@dnd-kit/sortable`, `@dnd-kit/utilities`, `@google/model-viewer`, `lucide-react`, `next`, `radix-ui`, `react-dom`, `react-icons`, `recharts`, `shadcn`, `sonner`, `@supabase/ssr`, `@supabase/supabase-js`, `@tanstack/react-table`, `@tiptap/extension-image`, `@tiptap/extension-link`, `@tiptap/extension-placeholder`, `@tiptap/extension-youtube`, `@tiptap/pm`, `@tiptap/react`, `@tiptap/starter-kit`, `tw-animate-css`, `vaul`, `@vercel/analytics`, `@vercel/speed-insights`, `zustand`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `react` connect `Sidebar & Navigation Shell` to `Cabang Dashboard Sections`, `UI Primitives (cn/Drawer)`, `Core Runtime Dependencies`, `Global Search & Command Palette`, `Chart Components`?**
...
- **Should `Cabang Dashboard Sections` be split into smaller, more focused modules?**
  _Cohesion score 0.06876750700280113 - nodes in this community are weakly interconnected._
